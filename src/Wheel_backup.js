...
import img1 from './IMG_2298.JPG';
import img2 from './IMG_3104.JPG';
import img3 from './IMG_3105.JPG';
import img4 from './IMG_3130.JPG';
import img5 from './IMG_3133.JPG';
import img6 from './IMG_3315.JPG';
import img7 from './IMG_4983.JPG';
import img8 from './IMG_5031.JPG';
...
class Wheel extends React.Component {
    ...
    handleClick = () => {
        ...
        clearTimeout(this.anim_id);
            ...
            //let scroll_speed = Math.random() * (800 - 100) + 100
    ...
    snap_back = () => {
        ...
        this.wheel.style.transitionDelay = '1.0s';
        this.wheel.style.transitionDuration = '0.1s';
        this.wheel.style.transform = `translate(-50%, -50%) rotate(${this.state.theta + theta_between}deg)`;

        // rotate the cards in the opposite direction of the wheel to maintain equilibrium
        for (let i = 0; i < this.wheel.children.length; i++) {
            this.wheel.children[i].style.transitionDelay = '1.0s';
            this.wheel.children[i].style.transitionDuration = '0.1s';
