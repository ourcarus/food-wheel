...
import img1 from './kfc.png';
import img2 from './menya.PNG';
import img3 from './saizeriya.jpg';
import img4 from './songfa.jpg';
import img5 from './soupspoon.png';
import img6 from './arnolds.png';
import img7 from './18chef.png';
import img8 from './itacho.png';
...
class Wheel extends React.Component {
    ...
    simulateClick = function(){
        ...
        // if (this.state.click_counter <20){
 
        //     document.getElementById("button").click()
        //     var new_click_counter = this.state.click_counter + 1;
        //     this.setState({ click_counter: new_click_counter });
        //     console.log("click_counter:",this.state.click_counter)
        //     console.log("simulated button clicked")
        ...
        //     }, 150);
        // }      
        // console.log("this.state.snap_in_progress",this.state.snap_in_progress)    
        // console.log("!this.state.loaded",!this.state.loaded)  
    }

    handleInterval = () => {
        this.handleClick()
        console.log("handleInterval count")
    ...
    handleClick = () => {
        ...
        console.log("snap_in_progress after click",this.state.snap_in_progress)
        if (this.state.snap_in_progress && !this.state.loaded) {
            return;
        } else {
            clearTimeout(this.anim_id);

            if (this.state.click_counter < 40){
                setTimeout(function(){
            ...
            let scroll_speed =(150 / 360) * 20;
            //let scroll_speed = (3600 / 360) * 20
            //let scroll_speed = Math.random() * (360 - 100) + 100
            console.log("scroll speed",scroll_speed)
    ...
    componentDidMount() {
        ...
        let temp_cards = []
        //let temp_cards = [img1,img2,img3,img4,img5,img6,img7,img8];
        let pic_cards = [img1,img2,img3,img4,img5,img6,img7,img8];
        ...
        for (let i = 0; i < 8; i++) {
            temp_cards.push(
                ...
                <Card radius={this.state.radius} theta={(Math.PI / 4) * i} center={center_of_wheel} key={`card_${i}`} pic={pic_cards[i]} amLoaded={this.children_loaded} />
            );
        }

        this.setState({ cards: temp_cards });
        console.log("snap_in_progress",this.state.snap_in_progress)
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <button id="button1" onClick={this.handleClick}>button1</button>
            </div>
        )
